...
namespace BlocksBeyondTheStars.Client
{
    ...
    public sealed class NetworkClient : IDisposable
    {
        ...
        public void Join(string playerName, string? password = null, string locale = "en", string? token = null, int viewDistanceChunks = 0, string? hostedToken = null)
            => Send(new JoinRequest { PlayerName = playerName, Password = password, Locale = locale, Token = token, ViewDistanceChunks = viewDistanceChunks, HostedToken = hostedToken });
