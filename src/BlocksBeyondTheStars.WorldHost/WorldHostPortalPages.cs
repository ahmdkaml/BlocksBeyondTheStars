...
<div class='card'>
 ...
 Germany; nothing is shared or sold. Deleting your account (button on the worlds page) permanently removes
 the account, sessions, your reports and all your worlds including saves. For any privacy request, email
 the address above.</p>
</div>
<p><a href='/'>Zurück · Back</a></p>");
    }
